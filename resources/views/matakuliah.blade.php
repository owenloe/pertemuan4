...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <center>
            <h1>Owen 03081220045</h1>
            <h2>Tabel Mata Kuliah 3 Semester Terakhir</h2>
            <a class="btn btn-secondary" href="Profil" role="button"><</a>
  ...
  <tbody>
    <tr>
      <th scope="row">1</th>
      <td>Jaringan & Keamanan Komputer</td>
      <td>3</td>
      <td>B</td>
    </tr>
    <tr>
    ...
    <tr>
      <th scope="row">8</th>
      <td>Pemodelan & Analisis Proses Bisnis</td>
      <td>3</td>
      <td>B</td>
    </tr>
    <tr>
    ...
    <tr>
      <th scope="row">13</th>
      <td>Leadership & Entrepreneurship</td>
      <td>2</td>
      <td>A-</td>
    </tr>
    <tr>
